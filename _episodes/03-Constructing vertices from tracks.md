...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:/eos/uscms/store/user/cmsdas/2025/short_exercises/trackingvertexing/run321167_Charmonium_AOD.root"))
...
The [SecondaryVertex](https://twiki.cern.ch/twiki/bin/edit/CMS/SecondaryVertex) collection is already available in the MiniAOD files. You can retrieve the collection type and format by doing:
 ~~~
 cp /eos/uscms/store/user/cmsdas/2025/short_exercises/trackingvertexing/run321167_Charmonium_MINIAOD.root $TMPDIR
...
> import ROOT
> 
> events = fwlite.Events("/eos/uscms/store/user/cmsdas/2025/short_exercises/trackingvertexing/run321167_Charmonium_MINIAOD.root")
